# -*- coding: utf-8 -*-
"""
Created on Tue May 26 20:37:35 2020
...
def get_jobs(keyword, num_jobs, verbose, path, slp_time):
    ...
    while len(jobs) < num_jobs:  #If true, should be still looking for new jobs.
        ...
        job_buttons = driver.find_elements_by_class_name("jobContainer")
        ...
        try:
            driver.find_element_by_xpath('//*[@id="FooterPageNav"]/div/ul/li[7]/a/span/i').click()
